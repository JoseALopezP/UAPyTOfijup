...
import styles from '../../Notificaciones-Traslados/Notificaciones-Traslados.module.css';
...
export default function TrasladosTab() {
    ...
    const activeWorkspaceData = useMemo(() => {
        ...
        return filtered.sort((a, b) => {
            ...
            return (parseDateWS(a.data.fechaAud || '')?.getTime() || 0) - (parseDateWS(b.data.fechaAud || '')?.getTime() || 0);
        });
