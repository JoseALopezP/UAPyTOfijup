...
export function SitCorporalSelectDate({ dateFunction, date, legSearch, setLegSearch, copyLeg }) {
    ...
    return(
        <div className={`${styles.selectDateBlock}`}>
            <button type="button" onClick={copyLeg} className={styles.copyButton}>Copiar Números de Legajo</button>
            ...
            <input className={`${styles.selectLegSearch}`} onChange={e => setLegSearch(e.target.value)} value={legSearch} />
        </div>
    );
}