...
export const generatePDF = async () => {
    ...
    for (let i = 1; i <= doc.internal.getNumberOfPages(); i++) {
        doc.setPage(i);
        doc.addImage(headerImage, 'JPEG', 0, 0, doc.internal.pageSize.getWidth(), 30);
        ...
        doc.addImage(footerImage, 'JPEG', footerX, footerY, footerWidth, footerHeight);
      }
